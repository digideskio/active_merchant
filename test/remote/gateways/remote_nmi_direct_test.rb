...
class NmiDirectTest < Test::Unit::TestCase
  include ActiveMerchant::Billing

  def setup
    @gateway = NmiDirectGateway.new(fixtures(:nmi))
  ...
  # FOR SOME REASON NMI DOESN'T MIND EXPIRED CARDS
